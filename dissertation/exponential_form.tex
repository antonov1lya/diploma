...
\begin{theorem}
    ...
    Таким образом, принятие нулевого значения параметром 
    ...
    Тогда согласно \cite{Lehmann1986} РНМН тест уровня $\alpha$ проверки гипотезы $H: \theta=\theta_0$ против альтернативы $K: \theta \neq \theta_0$ имеет вид:
    $$
